  ...
  <div class="row header">
    ...
    <div class="col-md-4">
      ...
      if ((!isset($_SESSION['email']))) {
        ...
        echo '<a href="logout.php?q=feedback.php" class="pull-right sub1 btn title3"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Sign Out</a>&nbsp;';
      }
      ?>
          ...
          <?php if (@$_GET['q']) echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;' . @$_GET['q'] . '</span>';
            ...
            echo '
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-10">
                          <a href="mailto:admin@gmail.com"style="color:#000000">admin@gmail.com</a><br/><br/>
